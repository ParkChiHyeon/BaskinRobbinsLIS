...
//		    	bout.flush();
	...
	// 이미지 업로드
	   ...
	   public void fileuploadImg(HttpServletRequest request, HttpServletResponse response,
	                              MultipartHttpServletRequest multiFile,
	                              @RequestParam MultipartFile upload,@RequestParam String nowday) {
...
//	          bout.flush();
	   ...
	   public byte[] filedownload(@RequestParam(value="uid") String uid,
			   ...
			   HttpServletRequest request, HttpServletResponse response,@RequestParam(value="nowday") String nowday) throws IOException {
		   byte[] bytes=null;
...
//		String path=WebUtils.getRealPath(request.getSession().getServletContext(), "/storage/notice/"+nowday+"/") ;
	   ...
	   @ResponseBody
	   public void fileDelete(@RequestParam(value="uid") String uid,
			   @RequestParam(value="fileName") String fileName,
			   HttpServletRequest request, HttpServletResponse response,@RequestParam(value="nowday") String nowday) throws IOException {

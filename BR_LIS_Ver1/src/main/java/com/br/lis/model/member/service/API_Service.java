...
@Service
	public class API_Service {
		...
		public void certifiedPhoneNumber(String phoneNumber, String cerNum) {
			String api_key = "NCSXHAZLCERE8DKQ"; // coolSMS 사이트에서 받은 인증키
	        String api_secret = "GIIQ8SVILBOG01WFEMRVCCQMFD1LSHYX"; // coolSMS 자체에 발급된 비밀키
	        Message coolsms = new Message(api_key, api_secret);

	        // 4개의 입력값 필요
	        HashMap<String, String> params = new HashMap<String, String>();
	        params.put("to", phoneNumber);    // 수신전화번호
	        params.put("from", "01050329744");    // 발신전화번호. 테스트시에는 발신,수신 둘다 본인 번호로 하면 됨 -> 발신전화 번호는 coolSMS에 등록해줘야됨

...
<body class="body">
		...
		<div id="contleft" class="contleft">
			...
			<div class="lnbBody" style="min-height: 550px;">
				...
				<!-- 각자 메뉴 -->
				<li id="lnb_1" class=""><a href="./memberInfoUpdate.do" >탈퇴회원 승인 및 조회</a></li> 
				<li id="lnb_2" class=""><a href="./membertt.do" >2</a></li>
				<li id="lnb_3" class=""><a href="./memberInfoUpdate.do" >3</a></li>
				<li id="lnb_4" class=""><a href="./memberInfoUpdate.do" >4</a></li>
				<li id="lnb_5" class=""><a href="./memberInfoUpdate.do" >5</a></li>
				<li id="lnb_6" class=""><a href="./memberInfoUpdate.do" >6</a></li>
				<li id="lnb_7" class=""><a href="./memberInfoUpdate.do" >7</a></li>
